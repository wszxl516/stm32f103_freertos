...
/* Vector Table */
HANDLER_DEFINE(SVC_Handler, vPortSVCHandler);
HANDLER_DEFINE(SysTick_Handler, xPortSysTickHandler);
HANDLER_DEFINE(PendSV_Handler, xPortPendSVHandler);
